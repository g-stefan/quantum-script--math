...
#include <XYO/QuantumScript.Extension/Math/Library.hpp>
#include <XYO/QuantumScript.Extension/Math/Copyright.hpp>
#include <XYO/QuantumScript.Extension/Math/License.hpp>
#include <XYO/QuantumScript.Extension/Math/Version.hpp>

#include <XYO/QuantumScript.Extension/Math/Library.Source.cpp>
...
#ifndef XYO_QUANTUMSCRIPT_EXTENSION_MATH_LIBRARY
#	ifdef XYO_PLATFORM_COMPILE_DYNAMIC_LIBRARY
extern "C" XYO_QUANTUMSCRIPT_EXTENSION_MATH_EXPORT void quantumScriptExtension(XYO::QuantumScript::Executive *executive, void *extensionId) {
	XYO::QuantumScript::Extension::Math::initExecutive(executive, extensionId);
};
#	endif
#endif
