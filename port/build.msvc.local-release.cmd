...
echo -^> local-release quantum-script-extension-math
...
call :cmdX xyo-cc quantum-script-extension-math --archive-release-sha512 --version-file=source/quantum-script-extension-math.version.ini
