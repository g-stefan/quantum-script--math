...
cmdX xyo-cc --mode=$ACTION @util/quantum-script-extension-math.static.compile.info
cmdX xyo-cc --mode=$ACTION @util/quantum-script-extension-math.dynamic.compile.info
